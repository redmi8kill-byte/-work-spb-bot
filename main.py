...
async def admin_dashboard(request: Request):
    if not is_telegram_admin(request):
        return JSONResponse({"ok": False, "message": "Нет доступа"}, status_code=403)
    return {"ok": True, "data": admin_stats()}
...
/* FINAL NEON UI POLISH */
body{background:radial-gradient(circle at 10% 0%,#142a55 0,transparent 25%),radial-gradient(circle at 95% 8%,#4a145f 0,transparent 24%),radial-gradient(circle at 50% 65%,#082b4a 0,transparent 32%),#02050b;overflow-x:hidden}
body:before{content:"";position:fixed;inset:0;pointer-events:none;background:linear-gradient(120deg,transparent 35%,rgba(139,92,255,.035),transparent 65%);z-index:-1}
.topbar{height:76px;background:rgba(3,7,18,.72);border-bottom:1px solid rgba(76,131,255,.22);box-shadow:0 0 30px rgba(55,90,255,.12)}
.brandIcon{border-color:#ffd76a55;background:radial-gradient(circle,#273d70,#07101f);box-shadow:0 0 18px #ffd76a30,0 0 32px #42e8ff18,inset 0 0 20px #8b5cff25}
.iconBtn{border-color:#3554a2;background:linear-gradient(135deg,#07152d,#151039);box-shadow:0 0 15px #315cff25}
.hero{display:none}
.features{grid-template-columns:repeat(4,1fr);margin:10px 0 14px}.feature{border-color:#1452bb;background:linear-gradient(180deg,#071b43,#061021);box-shadow:0 0 18px #1764ff20,inset 0 0 22px #42e8ff06}.feature b{color:#42e8ff;font-size:20px}.feature small{font-size:9px}
.view{padding:12px 14px 24px}.sectionTitle{margin:20px 2px 11px}.sectionTitle h2{font-size:23px;text-shadow:0 0 18px #ffffff12}
.neonProfile{position:relative;display:flex;align-items:center;gap:13px;padding:16px;border:1px solid #7a36ff;border-radius:21px;background:linear-gradient(110deg,rgba(7,22,48,.96),rgba(12,9,37,.96));box-shadow:0 0 26px #8b5cff22,inset 0 0 28px #42e8ff08;overflow:hidden}.neonProfile:after{content:"";position:absolute;right:-40px;top:-70px;width:190px;height:190px;background:radial-gradient(circle,#ff2fbd2b,transparent 66%);pointer-events:none}.neonAvatar{width:65px;height:65px;flex:0 0 65px;border-radius:50%;display:grid;place-items:center;font-size:25px;font-weight:950;color:#fff;background:radial-gradient(circle at 35% 30%,#fff,#7a8cff 18%,#263dff 45%,#8b22ff);border:1px solid #5ceeff;box-shadow:0 0 25px #42e8ff55,0 0 35px #8b5cff35}.profileMeta{position:relative;z-index:1;min-width:0;flex:1}.profileMeta b{font-size:20px}.profileMeta small{display:block;color:#42e8ff;font-size:12px;margin-top:2px}.verified{display:inline-flex;margin-top:7px;border:1px solid #23dfff;border-radius:999px;padding:5px 9px;color:#5deaff;font-size:9px;font-weight:900}.vipBadge{position:relative;z-index:1;border:1px solid #ffd76a;border-radius:999px;padding:8px 10px;color:#ffe58b;background:#ffd76a12;font-size:10px;font-weight:950;box-shadow:0 0 15px #ffd76a25}
.statGrid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin:12px 0}.miniStat{border:1px solid #1558d7;border-radius:16px;padding:11px 8px;background:linear-gradient(180deg,#061b48,#071123);box-shadow:0 0 18px #1468ff20,inset 0 0 20px #42e8ff05}.miniStat .icon{font-size:18px;color:#42e8ff}.miniStat small{display:block;color:#6eeaff;font-size:8px;line-height:1.2;margin-top:4px}.miniStat b{display:block;font-size:19px;margin-top:5px;color:#fff;text-shadow:0 0 12px #42e8ff30}.searchBox{display:flex;gap:8px;margin:12px 0}.searchBox input{flex:1;border:1px solid #1769ff;border-radius:16px;background:#061536;color:#fff;padding:14px 16px;box-shadow:0 0 20px #1468ff20}.filterBtn{width:50px;border:1px solid #5c42ff;border-radius:16px;background:#0a1240;color:#fff;box-shadow:0 0 18px #8b5cff30}
.cards{gap:10px}.card{border-color:#235ee9;background:linear-gradient(180deg,#081c47,#080d1d);box-shadow:0 0 20px #1468ff1e,0 14px 34px #00000040,inset 0 0 25px #8b5cff08;transition:.2s transform,.2s box-shadow}.card:active{transform:scale(.98)}.card.hot{border-color:#d43cff;box-shadow:0 0 25px #d43cff28,0 14px 34px #00000040}.card h3{font-size:14px}.card .price{font-size:22px}.miniBtn{background:linear-gradient(90deg,#fff0a8,#ffd76a);box-shadow:0 0 18px #ffd76a35}.tag{background:linear-gradient(90deg,#b72cff,#ff46c7);color:#fff;box-shadow:0 0 17px #c42fff66}
.channelCard{margin-top:16px;border-color:#b22fff;min-height:170px;padding:18px;background:radial-gradient(circle at 90% 10%,#ff3cc83a,transparent 30%),radial-gradient(circle at 15% 80%,#197cff3d,transparent 35%),linear-gradient(120deg,#071a3c,#171044 55%,#2a0d43);box-shadow:0 0 30px #8b5cff24,0 16px 40px #00000045,inset 0 0 35px #42e8ff08}.channelIcon{width:72px;height:72px;flex-basis:72px}.channelBody h3{font-size:19px}.channelBtn{background:linear-gradient(90deg,#6c20ff,#df24ff);box-shadow:0 0 25px #a532ff45}
.recentHead{display:flex;justify-content:space-between;align-items:center;margin:22px 2px 10px}.recentHead h2{margin:0;font-size:22px}.recentHead span{color:#42e8ff;font-size:11px}.recentOrder{display:flex;align-items:center;gap:12px;padding:14px;border:1px solid #174d9f;border-radius:17px;background:linear-gradient(100deg,#061737,#07101e);box-shadow:0 0 18px #1468ff12}.orderIcon{width:46px;height:46px;border-radius:50%;display:grid;place-items:center;background:#082d71;color:#fff;font-size:21px;border:1px solid #1b76ff}.orderBody{flex:1;min-width:0}.orderBody b{font-size:13px}.orderBody small{display:block;color:#8096b2;font-size:9px;margin-top:3px}.workPill{border:1px solid #19e49c;border-radius:999px;padding:5px 8px;color:#26eaa2;background:#0a4d3820;font-size:9px;font-weight:900}.recentPrice{font-weight:950;font-size:16px;color:#fff;margin-left:auto}
.richScreen{border:1px solid #2654d8;border-radius:22px;padding:15px;background:linear-gradient(180deg,#061638,#050b18);box-shadow:0 0 25px #1468ff17}.screenTitle{font-size:20px;font-weight:950}.screenSub{color:#8093ad;font-size:10px;margin-top:3px}.filterChips{display:flex;gap:7px;overflow:auto;margin:12px 0}.filterChip{white-space:nowrap;border:1px solid #284f9c;background:#071633;color:#8ca3c4;border-radius:999px;padding:7px 11px;font-size:9px}.filterChip.active{background:linear-gradient(90deg,#6928ff,#b52dff);color:#fff;border-color:#9c59ff;box-shadow:0 0 18px #8b5cff30}.richTariff{position:relative;border:1px solid #1d66e8;border-radius:18px;padding:15px;margin-top:10px;background:linear-gradient(120deg,#071a40,#0a1024);box-shadow:0 0 18px #1468ff18}.richTariff.hot{border-color:#e239ff;box-shadow:0 0 22px #d72fff2b}.richTariff .rtIcon{width:40px;height:40px;border-radius:50%;display:grid;place-items:center;background:#123b93;border:1px solid #42e8ff;color:#fff;float:left;margin-right:10px}.richTariff h3{margin:1px 0 3px;font-size:16px}.richTariff small{color:#9ab0cc;font-size:9px}.richTariff ul{clear:both;padding-left:18px;color:#9db4d1;font-size:9px;line-height:1.7;margin:12px 0 8px}.richTariff li::marker{color:#27e6a0}.richTariff .rtPrice{font-size:21px;font-weight:950;color:#fff}.rtBtn{float:right;border:0;border-radius:10px;padding:9px 14px;background:linear-gradient(90deg,#fff0a8,#ffd76a);font-weight:950;color:#08121e}.popularRibbon{position:absolute;top:-9px;left:50%;transform:translateX(-50%);background:linear-gradient(90deg,#8b24ff,#ff37d2);padding:4px 10px;border-radius:999px;font-size:8px;font-weight:950;box-shadow:0 0 18px #c43dff55}
.packageHero{border:1px solid #2464ef;border-radius:20px;padding:17px;background:radial-gradient(circle at 85% 15%,#ff2acb31,transparent 32%),linear-gradient(120deg,#061a43,#111034);box-shadow:0 0 25px #1468ff20}.packageItem{position:relative;border:1px solid #2458d0;border-radius:19px;padding:16px;margin-top:11px;background:linear-gradient(120deg,#081b43,#0a1023);box-shadow:0 0 20px #1468ff18}.packageItem .discount{position:absolute;right:12px;top:12px;background:#ff2f67;color:#fff;border-radius:9px;padding:5px 8px;font-size:9px;font-weight:950}.packageItem .pprice{font-size:22px;font-weight:950;color:#fff;margin-top:9px}.packageItem del{color:#6e829e;font-size:9px;margin-left:5px}.packageItem .buy{float:right;margin-top:-28px;border:0;border-radius:11px;padding:10px 16px;background:linear-gradient(90deg,#fff0a8,#ffd76a);font-weight:950}
.cartItem{border:1px solid #5b2ce4;border-radius:18px;padding:14px;background:linear-gradient(120deg,#091b42,#120d2b);box-shadow:0 0 22px #8b5cff18}.cartTop{display:flex;align-items:center;gap:10px}.cartIcon{width:42px;height:42px;border-radius:13px;display:grid;place-items:center;background:#103d92;border:1px solid #42e8ff}.cartQty{display:flex;align-items:center;gap:8px;margin-top:12px}.cartQty button{width:29px;height:29px;border-radius:9px;border:1px solid #2f58a5;background:#081a3e;color:#fff}.promo{display:flex;gap:8px;margin-top:14px}.promo input{flex:1}.promo button{border:1px solid #7a43ff;border-radius:12px;background:#3c1a93;color:#fff;padding:10px;font-weight:900}.checkoutSum{margin-top:13px;border:1px solid #6e31ff;border-radius:20px;padding:16px;background:linear-gradient(120deg,#0b183b,#180d33);box-shadow:0 0 25px #8b5cff20}.payBtn{width:100%;border:0;border-radius:13px;padding:13px;margin-top:12px;background:linear-gradient(90deg,#7b2cff,#d92cff);color:#fff;font-weight:950;box-shadow:0 0 24px #b42dff42}
.profileStats{display:grid;grid-template-columns:repeat(3,1fr);margin-top:11px;border:1px solid #174eae;border-radius:16px;overflow:hidden}.profileStat{padding:11px;text-align:center;background:#071a3d;border-right:1px solid #174eae}.profileStat:last-child{border-right:0}.profileStat b{display:block;font-size:17px}.profileStat small{color:#7892b5;font-size:8px}.profileList{border-color:#184ca8;background:#061633;box-shadow:0 0 20px #1468ff12}.profileItem{border-color:#173e80;padding:14px}.profileItem:hover{background:#0b2048}.profileItem b:first-child{font-size:12px}.profileItem small{font-size:9px}
.adminHero{border-color:#6d32ff;background:radial-gradient(circle at 85% 10%,#ff2cb52c,transparent 28%),linear-gradient(135deg,#081b44,#160d30);box-shadow:0 0 30px #8b5cff25}.adminActions{gap:7px}.adminAction{border-color:#174ca9;background:#061736;box-shadow:0 0 15px #1468ff14}.adminAction strong{color:#42e8ff}.userCard{border-color:#1b55b9;background:linear-gradient(100deg,#071936,#0a1023);box-shadow:0 0 15px #1468ff12}.userAvatar{box-shadow:0 0 15px #42e8ff35}
.bottom{border-color:#2352b6;background:rgba(3,9,24,.9);box-shadow:0 0 28px #1468ff1e,0 15px 45px #000b}.nav{color:#6f8bb3}.nav.active{background:linear-gradient(135deg,#102a69,#351260);color:#fff;box-shadow:inset 0 0 22px #6d2dff35,0 0 14px #6d2dff20}.nav.admin{color:#ffd76a}
@media(max-width:520px){.statGrid{grid-template-columns:repeat(2,1fr)}.cards{grid-template-columns:repeat(3,1fr)}.card{padding:12px 9px}.card h3{font-size:12px}.card .price{font-size:18px}.channelCard{align-items:flex-start}.channelIcon{width:58px;height:58px;flex-basis:58px;font-size:27px}.channelBody h3{font-size:15px}.channelBody p{font-size:9px}.recentOrder{padding:11px}.recentPrice{font-size:13px}.nav{font-size:7px}.nav .ico{font-size:16px}}
@media(max-width:380px){.cards{grid-template-columns:1fr}.statGrid{grid-template-columns:repeat(2,1fr)}}
</style>
</head>
<body>
<div class="app">
...
<section id="home" class="view active"><div class="neonProfile"><div class="neonAvatar" id="homeAvatar">Р</div><div class="profileMeta"><b id="homeName">Иван Петров</b><small id="homeUsername">@пользователь</small><span class="verified">◉ ✓ Проверенный пользователь</span></div><div class="vipBadge">♛ VIP</div></div><div class="statGrid"><div class="miniStat"><div class="icon">♧</div><small>Всего<br>пользователей</small><b id="homeUsers">—</b></div><div class="miniStat"><div class="icon">▣</div><small>Сегодня</small><b id="homeToday">+0</b></div><div class="miniStat"><div class="icon">◌</div><small>Активные<br>(7 дней)</small><b>—</b></div><div class="miniStat"><div class="icon">🛒</div><small>Всего заказов</small><b id="homeOrders">0</b></div></div><div class="searchBox"><input placeholder="Поиск по категориям, услугам..." oninput="showToast('Поиск будет подключён к каталогу')"><button class="filterBtn" onclick="go('tariffs')">☷</button></div><div class="sectionTitle"><h2>Популярные тарифы</h2><span style="color:var(--cyan);cursor:pointer" onclick="go('tariffs')">Все тарифы →</span></div><div id="homeCards" class="cards"></div><div class="channelCard"><div class="channelGlow"></div><div class="channelIcon">✈</div><div class="channelBody"><span class="channelBadge">Официальный канал</span><h3>💼 Работа в Питере</h3><p>Вакансии, новости, новые предложения и полезная информация каждый день!</p><button class="channelBtn" onclick="openChannel()">Перейти в Telegram-канал <b>→</b></button></div></div><div class="recentHead"><h2>Последние заказы</h2><span onclick="go('profile')">Все заказы →</span></div><div id="homeRecent" class="recentOrder"><div class="orderIcon">□</div><div class="orderBody"><b>Пока нет заказов</b><small>Выберите тариф и отправьте заявку</small></div></div></section>

<section id="tariffs" class="view"><div class="richScreen"><div class="screenTitle">Выбери свой тариф</div><div class="screenSub">Больше заказов — больше заработка!</div><div class="filterChips"><button class="filterChip active">Все</button><button class="filterChip">Популярные</button><button class="filterChip">Стандарт</button><button class="filterChip">Премиум</button></div><div id="tariffCards"></div></div></section>
<section id="packages" class="view"><div class="packageHero"><div style="font-size:22px;font-weight:950">🎁 Готовые решения</div><div style="color:#9bb2d0;font-size:10px;margin-top:4px">Выбирай пакет и экономь на размещениях</div></div><div class="filterChips"><button class="filterChip active">Популярные</button><button class="filterChip">Базовые</button><button class="filterChip">Премиум</button></div><div id="packageCards"></div></section>
<section id="cart" class="view"><div class="sectionTitle"><div><h2>Корзина <span id="cartCount"></span></h2></div><span onclick="clearCart()" style="cursor:pointer;color:#ff6c8a">🗑 Очистить</span></div><div id="cartList" class="list"></div><div class="promo"><input id="promoCode" placeholder="Введите промокод"><button onclick="showToast('Промокод проверяется менеджером')">Применить</button></div><div id="cartSummary"></div></section>

<section id="profile" class="view"><div class="sectionTitle"><div><h2>Профиль</h2><span>Ваш аккаунт в сервисе</span></div><span>⚙</span></div><div class="neonProfile"><div class="neonAvatar" id="avatar">Р</div><div class="profileMeta"><b id="profileName">Работодатель</b><small id="profileUsername">@пользователь</small><span class="verified">◉ ✓ Проверенный пользователь</span></div><div class="vipBadge">♛ VIP</div></div><div class="profileStats"><div class="profileStat"><b id="profileOrderCount">0</b><small>заказов</small></div><div class="profileStat"><b id="profileSum">0 ₽</b><small>сумма заказов</small></div><div class="profileStat"><b>сегодня</b><small>с нами</small></div></div><div class="profileList"><div class="profileItem" onclick="showHistory()"><div><b>📋 Мои заказы</b><small>История отправленных заявок</small></div><b>›</b></div><div class="profileItem" onclick="showHow()"><div><b>💡 Как это работает</b><small>От заявки до публикации</small></div><b>›</b></div><div class="profileItem" onclick="openChannel()"><div><b>📢 Наш Telegram-канал</b><small>Вакансии и новости Санкт-Петербурга</small></div><b>›</b></div><div class="profileItem" onclick="openSupport()"><div><b>💬 Поддержка</b><small>Написать администратору в Telegram</small></div><b>›</b></div></div><div id="history"></div></section>
...
function card(s){return `<div class="richTariff ${s.id===2?'hot':''}">${s.id===2?'<span class="popularRibbon">Самый популярный</span>':''}<div class="rtIcon">${s.id===3?'♢':s.id===2?'★':'♛'}</div><h3>${esc(s.name)}</h3><small>${esc(s.subtitle||'Оптимальный выбор')}</small><ul>${s.features.slice(0,3).map(f=>`<li>${esc(f)}</li>`).join('')}</ul><span class="rtPrice">${rub(s.price)}</span><button class="rtBtn" onclick="add(${s.id})">Выбрать</button><div style="clear:both"></div></div>`}
function packageCard(s){return `<div class="packageItem"><div style="font-weight:950;font-size:15px">🎁 ${esc(s.name)}</div><small style="color:#9bb0c8">${esc(s.subtitle)}</small>${s.price?`<div class="pprice">${rub(s.price)} <del>${rub(Math.round(s.price*1.15))}</del></div>`:''}<div style="color:#9ab1cf;font-size:9px;line-height:1.6;margin-top:8px">${s.features.slice(0,3).map(f=>'✓ '+esc(f)).join('<br>')}</div><button class="buy" onclick="add(${s.id})">Купить</button><div style="clear:both"></div></div>`}
function renderTariffs(){const ts=services.filter(s=>s.type==='Разовое размещение');document.getElementById('tariffCards').innerHTML=ts.map(card).join('');document.getElementById('homeCards').innerHTML=ts.slice(0,3).map(card).join('')}
function renderHomeLocal(){document.getElementById('homeOrders').textContent=orders.length;const recent=document.getElementById('homeRecent');if(orders.length){const o=orders[0];recent.innerHTML=`<div class="orderIcon">□</div><div class="orderBody"><b>Заказ #${o.id}</b><small>${esc((o.services||[]).join(', '))}</small></div><span class="workPill">● ${o.status==='done'?'Выполнено':'В работе'}</span><div class="recentPrice">${rub(o.total)}</div>`}}
function renderPackages(){document.getElementById('packageCards').innerHTML=services.filter(s=>s.type==='Пакет').map(packageCard).join('')}
...
function renderCart(){const list=document.getElementById('cartList');document.getElementById('cartCount').textContent=cart.length?`(${cart.length})`:'';document.getElementById('navCount').textContent=cart.length?` ${cart.length}`:'';if(!cart.length){list.innerHTML='<div class="empty">🛒<br><br>Корзина пока пуста.<br>Выберите тариф или пакет.</div>';document.getElementById('cartSummary').innerHTML='';return}list.innerHTML=cart.map(id=>{const s=byId(id);return `<div class="cartItem"><div class="cartTop"><div class="cartIcon">🎁</div><div style="flex:1"><b>${esc(s.name)}</b><small style="display:block;color:#8ba1bd;font-size:9px;margin-top:3px">${esc(s.subtitle)}</small></div><button onclick="remove(${id})" style="border:0;background:none;color:#ff6c8a;font-size:18px">×</button></div><div class="cartQty"><button onclick="remove(${id})">−</button><b>1</b><button onclick="add(${id})">+</button><strong style="margin-left:auto">${rub(s.price)}</strong></div></div>`}).join('');const total=cart.reduce((a,id)=>a+byId(id).price,0);document.getElementById('cartSummary').innerHTML=`<div class="checkoutSum"><div class="sumline"><span>Тарифы и услуги</span><b>${rub(total)}</b></div><div class="sumline"><span>Скидка</span><b style="color:#27e6a0">0 ₽</b></div><div class="sumline total"><span>Итого</span><b>${rub(total)}</b></div><button class="payBtn" onclick="go('checkout')">▣ Оплатить</button><div style="text-align:center;color:#42e8ff;font-size:8px;margin-top:8px">🔒 Безопасная оплата</div></div>`}
...
function renderProfile(){const u=tg?.initDataUnsafe?.user;if(u){const name=(u.first_name||'Пользователь')+(u.last_name?' '+u.last_name:'');document.getElementById('profileName').textContent=name;document.getElementById('homeName').textContent=name;document.getElementById('homeUsername').textContent=u.username?'@'+u.username:'@пользователь';document.getElementById('profileUsername').textContent=u.username?'@'+u.username:'@пользователь';document.getElementById('avatar').textContent=(u.first_name||'Р').slice(0,1).toUpperCase();document.getElementById('homeAvatar').textContent=(u.first_name||'Р').slice(0,1).toUpperCase()}const total=orders.reduce((a,o)=>a+(o.total||0),0);document.getElementById('profileOrderCount').textContent=orders.length;document.getElementById('profileSum').textContent=rub(total)}
