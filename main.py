...
WHEEL_PRIZES = [
    {"id": 1, "title": "Скидка 10%", "subtitle": "На следующее размещение", "code": "LUCK10", "weight": 28},
    {"id": 2, "title": "Скидка 20%", "subtitle": "На тариф «Под ключ»", "code": "LUCK20", "weight": 16},
    {"id": 3, "title": "+1 публикация", "subtitle": "Бонус к следующему заказу", "code": "LUCKPOST", "weight": 10},
    {"id": 4, "title": "Бесплатная публикация", "subtitle": "Для одной вакансии", "code": "LUCKFREE", "weight": 4},
    {"id": 5, "title": "VIP на 24 часа", "subtitle": "Особый статус в сервисе", "code": "LUCKVIP", "weight": 7},
    {"id": 6, "title": "Скидка 15%", "subtitle": "На пакет START", "code": "LUCK15", "weight": 20},
    {"id": 7, "title": "Бонус 100 ₽", "subtitle": "Скидка на следующий заказ", "code": "LUCK100", "weight": 10},
    {"id": 8, "title": "Попробуйте завтра", "subtitle": "Бонус обязательно найдётся", "code": "TRYTOMORROW", "weight": 5},
]
