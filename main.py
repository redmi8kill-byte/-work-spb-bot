...
<section id="wheel" class="view"><div class="wheelHead"><div><h2>КОЛЕСО УДАЧИ</h2><span>1 бесплатная попытка каждый день</span></div><div class="starBalance" id="wheelBalance">0 ⭐</div></div><div class="wheelCard"><div class="wheelTitle">Испытай удачу</div><div class="wheelWrap"><div class="pointer">▼</div><div class="wheel" id="wheelDisk"><div class="wheelLabel l1">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l2">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l3">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l4">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l5">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l6">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l7">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l8">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l9">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l10">ПОПРОБУЙ ЗАВТРА</div><div class="wheelLabel l11">−10%</div><div class="wheelLabel l12">−10%</div><div class="wheelLabel l13">−10%</div><div class="wheelLabel l14">−10%</div><div class="wheelLabel l15">−20%</div><div class="wheelLabel l16">−20%</div><div class="wheelLabel l17">−20%</div><div class="wheelLabel l18">⭐ БОНУС</div><div class="wheelLabel l19">⭐ БОНУС</div><div class="wheelLabel l20">🆓 FREE</div><div class="wheelInner"><b>SPB</b><small>УДАЧА</small></div></div></div><button class="spinBtn" id="spinBtn" onclick="spinWheel()">КРУТИТЬ КОЛЕСО</button><div class="wheelNote" id="wheelNote">После бесплатной попытки — 5 ⭐ за вращение.</div></div><div class="starPanel"><div class="starPanelTop"><div><b>⭐ Баланс</b><small>Внутренний баланс для платных вращений</small></div><strong id="starBalanceLarge">0 ⭐</strong></div><div class="packGrid"><button onclick="buyStars(25)"><b>25 ⭐</b><small>5 вращений</small></button><button onclick="buyStars(50)"><b>50 ⭐</b><small>10 вращений</small></button><button onclick="buyStars(100)"><b>100 ⭐</b><small>20 вращений</small></button></div><div class="wheelRules">Шансы: 😄 «Попробуй завтра» — 50% · 🎟️ Скидка 10% — 20% · 🎁 Скидка 20% — 15% · ⭐ Бонус к заказу — 10% · 🆓 Бесплатное размещение — 5%. Бесплатная попытка доступна раз в сутки.</div></div></section>
