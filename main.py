...
<style>
:root{--bg:#030b14;--panel:#071827;--line:#19354d;--text:#f8f3e8;--muted:#9baabc;--gold:#f5d38a;--gold2:#ffe8ad;--blue:#4b83ff;--green:#27c47d;--red:#ff6678;--shadow:0 20px 60px rgba(0,0,0,.38)}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:radial-gradient(circle at 50% -10%,#12304c 0,#061321 34%,#02070c 80%);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","Segoe UI",sans-serif}
...
.brand{display:flex;align-items:center;gap:10px;font-weight:900}.brandIcon{width:38px;height:38px;border:1px solid #b99852;border-radius:50%;display:grid;place-items:center;color:var(--gold);font-size:20px;background:#071827}.brand small{display:block;color:#8494a8;font-size:10px;margin-top:1px;font-weight:600}.topActions{display:flex;gap:7px}.iconBtn{width:38px;height:38px;border:1px solid #284158;background:#091a2a;color:#dce6f2;border-radius:13px}
...
.hero:after{content:"";position:absolute;inset:auto -20% -130px;height:260px;background:radial-gradient(ellipse,#d9a85d33,transparent 65%);pointer-events:none}.badge{display:inline-flex;padding:7px 11px;border-radius:999px;background:#f5d38a18;border:1px solid #f5d38a55;color:var(--gold2);font-size:10px;font-weight:900;letter-spacing:.6px;text-transform:uppercase}
.hero h1{position:relative;z-index:1;font-family:Georgia,serif;font-size:38px;line-height:1.02;margin:20px 0 12px;max-width:470px}.hero h1 span{color:var(--gold)}.hero p{position:relative;z-index:1;color:#d2dae4;line-height:1.5;font-size:14px;max-width:440px}.actions{display:flex;gap:10px;position:relative;z-index:1;margin-top:22px;flex-wrap:wrap}
.btn{border:1px solid #53677c;background:#091a2a;color:#fff;border-radius:15px;padding:13px 18px;font-weight:900}.btn.gold{background:linear-gradient(135deg,var(--gold2),var(--gold));color:#081321;border-color:transparent;box-shadow:0 8px 24px #f5d38a22}.btn.full{width:100%}
.features{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin:14px 0}.feature{padding:14px 8px;border:1px solid var(--line);background:#061625;border-radius:15px;text-align:center}.feature b{display:block;color:var(--gold);font-size:17px}.feature small{display:block;color:#aab6c5;font-size:9px;line-height:1.3;margin-top:5px}
.sectionTitle{display:flex;justify-content:space-between;align-items:end;margin:24px 2px 12px}.sectionTitle h2{margin:0;font-size:22px}.sectionTitle span{color:#8393a7;font-size:11px}.tabs{display:flex;gap:7px;margin-bottom:12px}.tabBtn{border:1px solid var(--line);background:#071827;color:#95a6b8;border-radius:999px;padding:8px 13px;font-size:11px;font-weight:800}.tabBtn.active{background:var(--gold);color:#071321;border-color:var(--gold)}
.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.card{position:relative;border:1px solid #254158;border-radius:17px;background:linear-gradient(180deg,#0a1d2f,#061320);padding:14px 11px;box-shadow:0 12px 30px #0000002e}.card.hot{border-color:#d9b35f}.card h3{font-size:14px;margin:0 0 4px}.price{font-size:21px;color:var(--gold2);font-weight:950;margin:5px 0 10px}.card ul{list-style:none;padding:0;margin:0 0 13px;color:#aab6c5;font-size:9px;line-height:1.65}.card li:before{content:"◉";color:var(--gold);font-size:6px;margin-right:5px;vertical-align:middle}.miniBtn{width:100%;border:0;border-radius:11px;padding:9px;background:linear-gradient(135deg,#ffe9b0,#eec96e);color:#071321;font-size:10px;font-weight:950}.tag{position:absolute;right:9px;top:9px;background:#f5d38a;color:#071321;padding:4px 6px;border-radius:7px;font-size:8px;font-weight:950}
...
<script>
const tg=window.Telegram&&window.Telegram.WebApp?window.Telegram.WebApp:null;if(tg){tg.ready();tg.expand();try{tg.setHeaderColor('#061321');tg.setBackgroundColor('#030b14')}catch(e){}}
